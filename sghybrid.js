//Story Generator v1.5 code (SPG HYBRID VERSION)
//by Estevan Galvez, 2020

//show stats
document.getElementById("mainText").innerHTML = "TIP: Even once full premises have been generated,<br>they're regenerated with new inciting incidents<br>every time you press the button, allowing you to<br>try as many new inciting incidents as you want.<br><br>NOTE: None of these are saved, so write down<br>your favorites somewhere.<br><br>"+nouns.length+" nouns, "+adjs.length+" adjectives, "+verbs.length+" verbs,<br>"+temps.length+" templates available. I'm aware this<br>looks like a web page from 1990.<br><br>Dedicated to the <a target=\"_self\" href=\"https:\/\/www.packtheater.com\/\">Pack Theater</a>. Check it out!<br><br><i>wordbank version: "+wordbankVer+"</i>";
...
//inciting incident writing function (SPG ver)

function getII() {
	var iString = temps[(Math.random()*temps.length)>>0];
	return "Then this changes everything: "+fillWords(iString)+".";
}
